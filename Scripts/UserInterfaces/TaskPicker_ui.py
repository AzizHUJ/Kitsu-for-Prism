...
class Ui_dlg_PickTask(object):
    def setupUi(self, dlg_PickTask):
        ...
        self.label_3 = QLabel(dlg_PickTask)
        self.label_3.setObjectName(u"label_3")

        self.verticalLayout_2.addWidget(self.label_3)

        self.comment_Text = QPlainTextEdit(dlg_PickTask)
    ...
    def retranslateUi(self, dlg_PickTask):
        ...
        self.label_2.setText(QCoreApplication.translate(
            "dlg_PickTask", u"Set status to:", None))
        self.label_3.setText(QCoreApplication.translate(
            "dlg_PickTask", u"Comment:", None))
        self.cb_preview.setText(QCoreApplication.translate(
            "dlg_PickTask", u"Set image as preview", None))
